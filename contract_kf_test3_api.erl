...
-define(ACCOUNT, "0x969332509db226847acfb3cd3b019bf308e3e641").
getBalance() ->
...
func_getMessage(Params) ->
	...
	P__values_list = string:tokens(P__values,"|"),
	eth_methodCall(?ACCOUNT,"getMessage",[{"uint256",P__id,64,0},{"uint256[]",etherlib:genArrayValueInput(P__values_list,"uint256"),string:len(etherlib:genArrayValueInput(P__values_list,"uint256")),0},{"string",P__message,string:len(P__message),32}]).
func_call(_) ->
...
func_remarks(Params) ->
	[P_|_] = Params,
	eth_propertyMappingCall(?ACCOUNT,"remarks",[{"uint256",P_,64,0}]).
func_add(Params) ->
	[P_x,P_y|_] = Params,
