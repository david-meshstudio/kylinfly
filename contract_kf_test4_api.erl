...
func_getMessage(Params) ->
	...
	eth_propertyMappingCall(?ACCOUNT,"getMessage",[{"uint256",P__id,64,0},{"uint256[]",etherlib:genArrayValueInput(P__values,"uint256"),string:len(etherlib:genArrayValueInput(P__values,"uint256")),0},{"string",P__message,string:len(P__message),32}]).
func_call(_) ->
